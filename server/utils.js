...
module.exports = {
	...
	getCageSchedule: function () {
		return new Promise((resolve, reject) => {
			axios
				.get(
					"https://ol2kpy1qhj.execute-api.us-east-1.amazonaws.com/prod/v1/cageSchedule"
				)
				.then(function (res) {
					resolve(res.data);
				})
	...
	getHittraxLeaders: function () {
		return new Promise((resolve, reject) => {
			...
			const leadersUrl =
				"https://spreadsheets.google.com/feeds/list/10HTYBCgCbN17gGHvK_4-BlPqMqGpvPdVi3FCjErKIRI/3/public/values?alt=json";
			...
			axios
				...
				.then((res) => {
					...
					let leaders = entries
						...
						.sort((a, b) => {
							if (b[statOfMonthSlug] < a[statOfMonthSlug]) return -1;
							if (b[statOfMonthSlug] > a[statOfMonthSlug]) return 1;
							return 0;
						});
	...
	getCollegeSignees: function () {
		return new Promise((resolve, reject) => {
			var signeesUrl =
				"https://spreadsheets.google.com/feeds/list/1bl9c_HhR5OpKpjTq9ZVno592ML02ouiO-w22Gg3IMkQ/1/public/values?alt=json";
